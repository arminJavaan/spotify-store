...
<section
  id="install-section"
  className="relative bg-gradient-to-br from-[#1db95422] via-[#12121266] to-[#1db95411] py-20 overflow-hidden min-h-[80vh] scroll-mt-24"
>
...
<section id="features" className="py-24">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      {/* مراحل سفارش */}
<section className="py-24 bg-gradient-to-br from-dark2 to-dark3">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
<section className="py-24">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="bg-gradient-to-br from-dark2 to-dark1 rounded-3xl p-12 shadow-2xl text-center">
      <motion.h2
